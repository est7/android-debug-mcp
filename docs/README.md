...
| [`v2/element-interaction.md`](./v2/element-interaction.md) | v2-F 设计 lock(element-driven interaction;Route B list + coord,采 mobile-mcp 形态;codex 2 轮复审 sign-off) | locked 2026-05-25 · § 验收 定稿 2026-05-25 |
...
| [`v2/test-plan-v2f.md`](./v2/test-plan-v2f.md) | v2-F 6 scenario 真机 manual checklist + evidence ledger(含 scenario C multi-window 三件齐 退化分支) | Phase 3 进行中 |
